package com.softwaretesting.magento.propertyreader;
...
public class PropertyReader {
   ...
   */
    ...
    public String getProperty(String propertyName) {
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/com/softwaretesting/magento/resources/propertiesfiles/config.properties");
